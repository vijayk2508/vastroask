...
<img src="Admin/template_setup/Resources/Images/leo.png" alt="Image" height="150"width="150" style="float: left;padding: 0 12px 2px 0;" />
                            	
<?php 
include "Admin/template_setup/Includes/db.php"; 
include "Admin/template_setup/Includes/functions.php";

GetHoroscopeByZodaic('Leo');
